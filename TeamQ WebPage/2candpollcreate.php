...
<?php
        $Display = 1;
        $pollName = $pollAccess = $pollDescription = $pollEnding = $pollCandidate1 = $pollCandidate2 = $codeSend = "";
        $hostname = 'localhost';
        $username = 'teamq';
        $password = 'dah4ieW1';
        $dbname = 'teamq';
        ...
        if(!empty($_REQUEST["pollname"]))
        {
                ...
                $randvotes1 = rand(100, 5000);
                $randvotes2 = rand(100, 5000);
...
*/
                ...
                $sql="INSERT INTO elections (ElectionName, accessCodeElection, descriptionElection, timeOutDate, Candidate1, Candidate2, votesCand1, votesCand2)
                VALUES ('$pollName', '$pollAccess', '$pollDescription','$pollEnding', '$pollCandidate1', '$pollCandidate2', 'randvotes1', '$randvotes2')";
...
<strong><div align="center" id="msg"> </div></strong>
        <form name="pollCreate" method="post" action="2candpollcreate.php" onsubmit="return validateForm()">
                ...
                <table align="center" border="1">
                        ...
                        <tr><td align="center"><b>Candidate Name:</b></td><td align="center"><input type="text" name="pollcand2name" id="polllcand2name">
...
<body>
        ...
        <form name="sendCode" method="post" action="2candpollcreate.php">
