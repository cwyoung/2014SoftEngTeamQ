...
<?php
        ...
        $pollName = $pollAccess = $pollDescription = $pollEnding = $pollCandidate1 = $pollCandidate2 =
                $pollCandidate3 = $pollCandidate4 = $codeSend = "";
        $hostname = 'localhost';
        $username = 'teamq';
        $password = 'dah4ieW1';
        $dbname = 'teamq';
        ...
        if(!empty($_REQUEST["pollname"]))
        {
                ...
                $sql="INSERT INTO elections (ElectionName, accessCodeElection, descriptionElection, timeOutDate, Candidate1, Candidate2, Candidate3, Candidate4)
                VALUES ('$pollName', '$pollAccess', '$pollDescription','$pollEnding', '$pollCandidate1', '$pollCandidate2', '$pollCandidate3', '$pollCandidate4')";
...
<strong><div align="center" id="msg"> </div></strong>
        <form name="pollCreate" method="post" action="4candpollcreate.php" onsubmit="return validateForm()">
...
<body>
        ...
        <form name="sendCode" method="post" action="4candpollcreate.php">
