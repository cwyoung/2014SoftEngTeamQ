...
<?php
        ...
        $pollName = $pollAccess = $pollDescription = $pollEnding = $pollCandidate1 = $pollCandidate2 =
                $pollCandidate3 = $pollCandidate4 = $pollCandidate5 = $pollCandidate6 = $pollCandidate7 = $pollCandidate8 = $codeSend = "";
        $hostname = 'localhost';
        $username = 'teamq';
        $password = 'dah4ieW1';
        $dbname = 'teamq';
        ...
        if(!empty($_REQUEST["pollname"]))
        {
                ...
                $pollCandidate6 = mysqli_real_escape_string($con, $_REQUEST['pollcand6name']);
                                $pollCandidate7 = mysqli_real_escape_string($con, $_REQUEST['pollcand7name']);
                $pollCandidate8 = mysqli_real_escape_string($con, $_REQUEST['pollcand8name']);

                $randvote1 = rand(1000, 5000);
                $randvote2 = rand(1000, 5000);
                $randvote3 = rand(1000, 5000);
                $randvote4 = rand(1000, 5000);
                $randvote5 = rand(1000, 5000);
                $randvote6 = rand(1000, 5000);
                $randvote7 = rand(1000, 5000);
                $randvote8 = rand(1000, 5000);
                /*echo $pollName . '<br>';
                echo $pollAccess . '<br>';
                ...
                echo $pollCandidate6 . '<br>';
                                echo $pollCandidate7 . '<br>';
                echo $pollCandidate8 . '<br>'; */


                $sql="INSERT INTO elections (ElectionName, accessCodeElection, descriptionElection, timeOutDate, Candidate1, Candidate2, Candidate3, Candidate4, Candidate5, Candidate6, Candidate7, Candidate8, votesCand1, votesCand2, votesCand3, votesCand4, votesCand5, votesCand6, votesCand7, votesCand8)
                VALUES ('$pollName', '$pollAccess', '$pollDescription','$pollEnding', '$pollCandidate1', '$pollCandidate2', '$pollCandidate3', '$pollCandidate4', '$pollCandidate5', '$pollCandidate6', '$pollCandidate7', '$pollCandidate8', '$randvote1', '$randvote2', '$randvote3', '$randvote4', '$randvote5', '$randvote6', '$randvote7', '$randvote8')";
...
<script>
        function validateForm()
        {
                ...
                var candidateSix=document.forms["pollCreate"]["pollcand6name"].value;
                if (candidateSix==null ||candidateSix=="")
                {
                        document.getElementById("msg").innerHTML = "Please provide a name for candidate #6";
                        return false;
                }
                                var candidateSeven=document.forms["pollCreate"]["pollcand7name"].value;
                if (candidateSeven==null ||candidateSeven=="")
                {
                        document.getElementById("msg").innerHTML = "Please provide a name for candidate #7";
                        return false;
                }

                var candidateEight=document.forms["pollCreate"]["pollcand8name"].value;
                if (candidateEight==null ||candidateEight=="")
                {
                        document.getElementById("msg").innerHTML = "Please provide a name for candidate #8";
                        return false;
                }
        }
...
<strong><div align="center" id="msg"> </div></strong>
        <form name="pollCreate" method="post" action="8candpollcreate.php" onsubmit="return validateForm()">
                ...
                <table align="center" border="1">
                        ...
                        <tr><td align="center"><b>Candidate Name:</b></td><td align="center"><input type="text" name="pollcand6name" id="pollcand6name">
                                                <tr><td align="center"><b>Candidate Name:</b></td><td align="center"><input type="text" name="pollcand7name" id="pollcand7name">
                        <tr><td align="center"><b>Candidate Name:</b></td><td align="center"><input type="text" name="pollcand8name" id="pollcand8name">
...
<body>
        ...
        <form name="sendCode" method="post" action="8candpollcreate.php">
