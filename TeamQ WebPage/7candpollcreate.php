...
<?php
        ...
        $pollName = $pollAccess = $pollDescription = $pollEnding = $pollCandidate1 = $pollCandidate2 =
                $pollCandidate3 = $pollCandidate4 = $pollCandidate5 = $pollCandidate6 = $pollCandidate7 = $codeSend = "";
        $hostname = 'localhost';
        $username = 'teamq';
        $password = 'dah4ieW1';
        $dbname = 'teamq';
        ...
        if(!empty($_REQUEST["pollname"]))
        {
                ...
                $sql="INSERT INTO elections (ElectionName, accessCodeElection, descriptionElection, timeOutDate, Candidate1, Candidate2, Candidate3, Candidate4, Candidate5, Candidate6, Candidate7)
                VALUES ('$pollName', '$pollAccess', '$pollDescription','$pollEnding', '$pollCandidate1', '$pollCandidate2', '$pollCandidate3', '$pollCandidate4', '$pollCandidate5', '$pollCandidate6', '$pollCandidate7')";
...
<strong><div align="center" id="msg"> </div></strong>
        <form name="pollCreate" method="post" action="7candpollcreate.php" onsubmit="return validateForm()">
...
<body>
        ...
        <form name="sendCode" method="post" action="7candpollcreate.php">
